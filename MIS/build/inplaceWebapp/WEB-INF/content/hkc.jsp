 ...
 <a href="emailUs">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				...
				<ul class="dropdown-menu dropdown-user">
					<li><a href="RecordAction_hxc"><i class="fa fa-user fa-fw"></i>历史记录查询</a>
					</li>
										...
										<tbody>
											<s:if test="#session.vip!=null">
												...
												<tr>
													...
													<td><a href="ManageAction_appiont?park.oid=<s:property value="#list.oid"/>" class="btn btn-primary btn-sm">预约</a>
											...
											<s:else>
												...
												<tr>
													...
													<td>5元/h</td>
													<td><s:property value="#list.state" /></td>
													<td><a href="register" class="btn btn-primary btn-sm">注册</a>
