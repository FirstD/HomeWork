                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td><a href="ManageAction_ykin?park.oid=<s:property value="#list.oid"/>" class="btn btn-primary btn-sm">空位进入</a>
                                                <a href="ManageAction_in?park.oid=<s:property value="#list.oid"/>" class="btn btn-primary btn-sm">会员到达</a>
                                                <a href="ManageAction_out?park.oid=<s:property value="#list.oid"/>" class="btn btn-danger btn-sm">离开</a>
                                                <a href="ManageAction_cancel?park.oid=<s:property value="#list.oid"/>" class="btn btn-success btn-sm">取消预约</a>
                                            </td>
...
<%--                                             <td><s:property value="#list.state"/></td> --%>
<!--                                             <td> -->
<%--                                             	<s:if test="<s:property value="#list.state"/>=='未停'"> --%>
<%--                                             		<a href="ManageAction_ykin?park.oid=<s:property value="#list.oid"/>" class="btn btn-primary btn-sm">空位进入</a> --%>
<%--                                             	</s:if> --%>
<%--                                             	<s:elseif test="<s:property value="#list.state"/>=='预约'"> --%>
<%--                                             		<a href="ManageAction_in?park.oid=<s:property value="#list.oid"/>" class="btn btn-primary btn-sm">会员到达</a> --%>
<%--                                             		<a href="ManageAction_cancel?park.oid=<s:property value="#list.oid"/>" class="btn btn-success btn-sm">取消预约</a> --%>
<%--                                             	</s:elseif> --%>
<%--                                             	<s:else> --%>
