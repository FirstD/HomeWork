                                ...
                                <div class="panel-body">
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                                <td><s:property value="#list.parkName"/></td>
                                                <td><s:property value="#list.adminName"/></td>
                                                <td>
                                                    <a href="ParkAction_delete" class="btn btn-primary btn-sm">删除</a>
                                                </td>
                                    ...
                                    <a href="bpa" class="btn btn-primary btn-sm">增加</a>
                                </div>
                     </div>
                    <!--End Advanced Tables -->
                </div>
