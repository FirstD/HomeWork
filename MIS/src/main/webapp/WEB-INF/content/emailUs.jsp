                            ...
                            <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <form role="form" action="Email_emailUs" method="post">
                                            	<div class="form-group">
		                                            <label>联系我们</label><br/>
		                                            <textarea class="form-control" rows="3" name="yijian" value="这里填写您的意见"></textarea><br/>
		                                            <label><s:property value="jieguo"/></label><br/>
		                                        </div>
                                                <button type="submit" class="btn btn-default">发送邮件</button>
                                                <s:property value="jieguo" />
