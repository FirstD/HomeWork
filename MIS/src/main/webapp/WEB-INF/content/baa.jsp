                            ...
                            <div class="panel-heading">
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <form role="form" action="AdminSRO!register">
                                                <label>账号：</label><input type="text" class="form-control" name="admin.name"></br>
                                                <label>密码：</label><input type="password" class="form-control" name="admin.password"></br>
                                                <label>权限：</label><select class="form-control" name="admin.power">
                                                	<option value="一般管理员">一般管理员</option>
                                                	<option value="系统管理员">系统管理员</option>
                                                </select>
                                                <label>停车场</label><select class="form-control" name="msg">
                                                	<s:iterator id="park" value="#request.parkList">
                                                		<option value="<s:property value="#park.name"/>"><s:property value="#park.name"/></option>
                                                	</s:iterator>
