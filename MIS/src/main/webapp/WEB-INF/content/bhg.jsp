                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><s:property value="#list.identity"/></td>
                                                <td>
                                                    <a href="RecordAction_hxc2?name=<s:property value="#list.name"/>" class="btn btn-success btn-sm">消费账单</a>
                                                    <a href="VipSRO!lh?vip.vid=<s:property value="#list.vid"/>" class="btn btn-danger btn-sm">添加黑名单</a>
                                                    <a href="VipSRO!jh?vip.vid=<s:property value="#list.vid"/>" class="btn btn-danger btn-sm">解除黑名单</a>
                                                </td>
                                            </tr>
                                            </s:iterator>
                                        </tbody>
