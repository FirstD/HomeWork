                                    ...
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><s:property value="#list.leave"/>天</td>
                                                <td>
                                              
                                                    <a href="Email_email?email=<s:property value="#list.email"/>&leave=<s:property value="#list.leave"/>" class="btn btn-danger btn-sm">催单</a>
                                                </td>
                                            </tr>
                                            </s:iterator>
